...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      imageSrcs: [],
      endpointName: 'image-classification-2022-03-16-00-02-28-614',
      endpointRegion: 'us-west-2',
      classLabels: 'Adidas asics avia fila new+balance nike puma reebok skechers under+armour',
    }
  }
  ...
  render() {
    return (
      <div>
            Adidas Center for Engagement Science: Brand Verifier
      <Form>
